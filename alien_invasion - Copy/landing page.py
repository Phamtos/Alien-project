...
class LandingPage:
    alien_one_imgs = [pg.image.load(f'images/bee{n}.png') for n in range(2)]
    alien_two_imgs = [pg.image.load(f'images/cat{n}.png') for n in range(2)]
    alien_three_imgs = [pg.image.load(f'images/mushroom{n}.png') for n in range(2)]
    ufo_imgs = [pg.image.load(f'images/poop{n}.png') for n in range(2)]
